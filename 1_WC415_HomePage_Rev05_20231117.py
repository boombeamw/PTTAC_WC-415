...
if uploaded_file is not None:
    ...
    def user_input_features():
        ...
        VIB_DE = st.sidebar.slider('VIB DE',0, 20,2)
        TEMP_NDE = st.sidebar.slider('TEMP NDE',0, 200,40)
        VIB_NDE = st.sidebar.slider('VIB NDE',0, 20,2)
...
data_train = pd.read_csv('./01.Dataset_for_deployment/20231116_For_deployment_1.csv')
...
df_ForPredict = df_Scaler[152115:,:]
